...
The file [`crossrefs.json`](crossrefs.json) maps every Mathlib declaration with a [cross-refence attribute](https://leanmachinelearning.org/LML/docs/Mathlib/Tactic/CrossRefAttribute.html#Cross-reference-attributes) (e.g. `@[stacks]`) to its source location and the corresponding
